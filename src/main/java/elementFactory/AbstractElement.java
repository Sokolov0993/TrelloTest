...
public abstract class AbstractElement implements Element   {
    ...
    public void waitToBeClickable() {
        new WebDriverWait(DriverSingleton.getDriver(), Duration.ofSeconds(10)).until(ExpectedConditions.elementToBeClickable(wrappedElement));
    }

    public void waitForVisibilityOf() {
        new WebDriverWait(DriverSingleton.getDriver(), Duration.ofSeconds(10)).until(ExpectedConditions.visibilityOf(wrappedElement));
    }

    public void waitForInVisibilityOf() {
        new WebDriverWait(DriverSingleton.getDriver(), Duration.ofSeconds(10)).until(ExpectedConditions.invisibilityOf(wrappedElement));
    }
    ...
    public void waitForAttributeContainsText(String attribute, String text) {
        ...
        new WebDriverWait(DriverSingleton.getDriver(), Duration.ofSeconds(10)).until(attributeContainsText);
    }
